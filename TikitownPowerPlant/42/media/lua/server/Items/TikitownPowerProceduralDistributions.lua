...
local function preDistributionMerge()
	...
	addMag("BookstoreBooks",     "TikitownPower.PlantFurnaceTechnicalManual",  1)
	addMag("BookstoreBooks",     "TikitownPower.PlantPumpTechnicalManual",  1)
	addMag("BookstoreBooks",     "TikitownPower.PlantCondenserTechnicalManual",  1)
	addMag("BookstoreBooks",     "TikitownPower.PlantTurbineTechnicalManual",  1)
	
	addMag("UniversityLibraryBooks",     "TikitownPower.PlantFurnaceTechnicalManual",  1)
	addMag("UniversityLibraryBooks",     "TikitownPower.PlantPumpTechnicalManual",  1)
	addMag("UniversityLibraryBooks",     "TikitownPower.PlantCondenserTechnicalManual",  1)
	addMag("UniversityLibraryBooks",     "TikitownPower.PlantTurbineTechnicalManual",  1)
