...
SuburbsDistributions.tikipowerplant = {
    ...
    metal_shelves = {
        procedural = true,
        procList = {
            { name = "tikitownpowerstorageShelves", min = 1, max = 99, weightChance = 60 },
            { name = "Electrician",                 min = 0, max = 1, weightChance = 25 },
            { name = "ToolStoreMisc",               min = 0, max = 1, weightChance = 15 },
			{ name = "tikitownpowerBooks", min = 2, max = 99, weightChance = 80 },
        }
    },
...
SuburbsDistributions.ttp_office = {
    ...
    shelves = {
        procedural = true,
        procList = {
            { name = "tikitownpowerBooks", min = 1, max = 2, weightChance = 80 },
