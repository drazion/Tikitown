...
function TikitownPower_RepairPartAction:start()
    ...
    self.oldMask    = self.character:getWornItem(ItemBodyLocation.MASK)
    ...
    if animName == "BlowTorch" then
        ...
        if self.mask then
            self.character:setWornItem(ItemBodyLocation.MASK, self.mask)
        end
...
function TikitownPower_RepairPartAction:stop()
    ...
    if self.oldPrimary or self.oldSecondary then
        ...
        self.character:setWornItem(ItemBodyLocation.MASK, self.oldMask)
    end
