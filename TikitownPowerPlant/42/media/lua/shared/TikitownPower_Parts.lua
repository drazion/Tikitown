...
TikitownPower.parts = {
    ...
    DeliveryInverterCoils   	= { label = "Inverter Coils",		max = 100, removable = true, wear_rate = 1, rep_anim="Disassemble", rep_sound="Dismantle" },
    DeliveryTransformerLinks 	= { label = "Transformer Links",    max = 100, removable = true, wear_rate = 1, rep_anim="Disassemble", rep_sound="Dismantle" },
    DeliveryBreakerArray   		= { label = "Breaker Array",        max = 100, removable = false, wear_rate = 1, rep_anim="Disassemble", rep_sound="Dismantle" },    
}
...
TikitownPower.TurbinePartDefs = {
    ...
    TurbineStator       		= { label = "Stator",          		max = 100, removable = true, wear_rate = 1, rep_anim="Disassemble", rep_sound="Dismantle" },
    TurbineCasing        		= { label = "Casing",          		max = 100, removable = false, wear_rate = 1, rep_anim="Blowtorch", rep_sound="Blowtorch"  },
    TurbineControlSystem 		= { label = "Control System",  		max = 100, removable = true, wear_rate = 1, rep_anim="Disassemble", rep_sound="Dismantle" },
...
TikitownPower.CondenserPartDefs = {
	 -- Condenser
    CondChamber             = { label = "Condenser Chamber",      max = 100, removable = false, wear_rate = 1, rep_anim="Blowtorch", rep_sound="Blowtorch"},
    CondWaterCircuits       = { label = "Cooling Water Circuits", max = 100, removable = false, wear_rate = 1, rep_anim="Disassemble", rep_sound="Dismantle" },
    CondWetAirPumps         = { label = "Wet Air Pumps",          max = 100, removable = false, wear_rate = 1, rep_anim="refuelgascan", rep_sound="GetWaterFromDispenserCeramic" },
    CondHotWell             = { label = "Hot Well",               max = 100, removable = false, wear_rate = 1, rep_anim="Blowtorch", rep_sound="Blowtorch" },
}

TikitownPower.FurnacePartDef = {
	 -- Coal Furnace
    FurnFurnace             = { label = "Coal Furnace",           max = 100, removable = false, wear_rate = 1, rep_anim="Blowtorch", rep_sound="Blowtorch" },
    FurnWaterWalls          = { label = "Water Walls",            max = 100, removable = false, wear_rate = 1, rep_anim="Blowtorch", rep_sound="Blowtorch" },
    FurnSuperHeater         = { label = "Superheater",            max = 100, removable = false, wear_rate = 1, rep_anim="Blowtorch", rep_sound="Blowtorch" },
    FurnReHeater            = { label = "Reheater",               max = 100, removable = false, wear_rate = 1, rep_anim="Disassemble", rep_sound="Dismantle" },
    FurnEcon                = { label = "Economizer",             max = 100, removable = false, wear_rate = 1, rep_anim="Blowtorch", rep_sound="Blowtorch" },
    FurnPreheat             = { label = "Air Preheater",          max = 100, removable = false, wear_rate = 1, rep_anim="Blowtorch", rep_sound="Blowtorch" },
    FurnControl             = { label = "Furnace Control System", max = 100, removable = true, wear_rate = 1, rep_anim="Disassemble", rep_sound="Dismantle" },
}
...
TikitownPower.PumpPartDef = {
    ...
    PumpShaft               = { label = "Pump Shaft",             max = 100, removable = false, wear_rate = 1, rep_anim="Blowtorch", rep_sound="Blowtorch" },
    PumpHousing             = { label = "Pump Housing",           max = 100, removable = false, wear_rate = 1, rep_anim="Blowtorch", rep_sound="Blowtorch" },
    PumpSeals               = { label = "Pump Seals",             max = 100, removable = true, wear_rate = 1, rep_anim="Disassemble", rep_sound="Dismantle" },
    PumpSuction             = { label = "Pump Suction Nozzle",    max = 100, removable = true, wear_rate = 1, rep_anim="Blowtorch", rep_sound="Blowtorch" },
    PumpDisch               = { label = "Pump Discharge Nozzle",  max = 100, removable = true, wear_rate = 1, rep_anim="Blowtorch", rep_sound="Blowtorch" },
